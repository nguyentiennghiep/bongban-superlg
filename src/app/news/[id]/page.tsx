...
export default function NewsDetailPage() {
  return (
    <div className="container mx-auto px-6 py-12">
      <h1 className="text-3xl font-bold mb-8">Chi tiết tin tức</h1>
          ...
          <div className="grid grid-cols-3 gap-8">
            ...
            <div className="col-span-2">
              <article className="mb-12">
                ...
                <h1 className="text-[24px] font-[600] mb-4 text-black">
                ...
                <ul className="list-disc pl-5 mb-4 text-[14px] leading-[22px] text-[#333333]">
                  <li>
                    Lorem ipsum dolor sit amet, consectetuer adipiscing elit.
                  </li>
            ...
            <div>
              <h2 className="text-[20px] font-[600] mb-6 text-black">
                Tin nổi bật khác
              </h2>
              <div className="space-y-6">
                ...
                <div className="group">
                  ...
                  <h3 className="text-[16px] font-[600] group-hover:text-[#FF1654]">
